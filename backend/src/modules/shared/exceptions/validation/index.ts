...
export class ValidationException extends BaseException {
     ...
     */
    constructor(message: 'Validation failed', issues: ValidationIssue[] = [], context?: ExceptionContext) {
...
export class SchemaValidationException extends BaseException {
     ...
     * @param context Additional context information
     */
    constructor(message: 'Schema validation failed', issues: ValidationIssue[] = [], context?: ExceptionContext) {
